...
function App() {
  return (
    <>
      <div className='flex flex-row'>
        ...
        <div className='w-1/3 bg-white p-6 overflow-y-auto h-screen'>
  <h2 className='text-2xl font-bold mb-4 text-gray-800'>Where to?</h2>
  ...
  <div className='justify justify-center'>
    <h3 className='text-xl font-semibold mb-4 text-gray-800'>Events Nearby</h3>
    
    <div className='space-y-3'>
      <div className='bg-gray-50 p-4 rounded-lg hover:bg-gray-100 cursor-pointer transition border border-gray-200'>
        <h4 className='font-semibold text-lg text-gray-800'>Pike Place Market</h4>
      ...
      <div className='bg-gray-50 p-4 rounded-lg hover:bg-gray-100 cursor-pointer transition border border-gray-200'>
        <h4 className='font-semibold text-lg text-gray-800'>Space Needle</h4>
        <div className='flex justify-between mt-2 text-sm text-gray-600'>
          <span>📍 1.2 miles</span>
